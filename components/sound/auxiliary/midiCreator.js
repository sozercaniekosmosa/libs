function MIDI_generator() {
    ...
    /**
     * A channel event is what it sounds like: an event from a keyboard or other instrument.
     *
     * @param timePos
     * @param eventType
     * @param channel
     ...
     * @constructor
     */
    function ChannelEvent(timePos, eventType, channel, p1, p2) {
        var payload = [p1];
        if (p2 !== undefined && typeof p2 == 'number') payload.push(p2);
        this.deltaTime = timePos;
